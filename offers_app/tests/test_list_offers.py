...
class OffersListTestCase(BaseOffersTestCase):
...
class OffersFilterTestCase(BaseOffersTestCase):
    ...
    def test_filter_by_creator(self):
        ...
        for offer in response.data:
            self.assertEqual(offer["creator"], self.user.id)
...
class OffersSearchTestCase(BaseOffersTestCase):
...
class EmptyOffersListTestCase(APITestCase):

    def setUp(self):
        self.client = APIClient()
        self.url = reverse("offers")

    def test_get_list_returns_empty_list_when_no_offers(self):
        response = self.client.get(self.url)
...
class OffersPaginationTestCase(APITestCase):
